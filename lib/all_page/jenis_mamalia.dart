...
class MencocokkanMamaliaPage extends StatefulWidget {
  const MencocokkanMamaliaPage({super.key});

  @override
  State<MencocokkanMamaliaPage> createState() => _MencocokkanMamaliaPageState();
}
