...
class MencocokkanReptilPage extends StatefulWidget {
  const MencocokkanReptilPage({super.key});

  @override
  State<MencocokkanReptilPage> createState() => _MencocokkanReptilPageState();
}

class _MencocokkanReptilPageState extends State<MencocokkanReptilPage> {
  // stopwatch
  late Stopwatch stopwatch;

  final List<String> correctOrder = ["Biawak", "Komodo", "Penyu Hijau"];
  ...
  void startGame() {
    ...
    placed = {"Biawak": null, "Komodo": null, "Penyu Hijau": null};
