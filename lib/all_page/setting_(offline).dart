...
import 'peringkat_(offline).dart';


void main() {
  runApp( SetingPageOffline());
}

class SetingPageOffline extends StatelessWidget {
  const SetingPageOffline({super.key});
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => PapanPeringkatPageOffline()),
                    );
                  },
